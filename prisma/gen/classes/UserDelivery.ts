...
export class _UserDelivery extends PrismaClass {
	...
	async *saveToTransaction(
		...
		if (this.id === undefined) {
			throw new Error('Invalid field on _UserDelivery.save(): id')
		}

		if (this.address === undefined) {
			throw new Error('Invalid field on _UserDelivery.save(): address')
		}

		if (this.zipcode === undefined) {
			throw new Error('Invalid field on _UserDelivery.save(): zipcode')
		}

		if (this.city === undefined) {
			throw new Error('Invalid field on _UserDelivery.save(): city')
		}

		if (this.country === undefined) {
			throw new Error('Invalid field on _UserDelivery.save(): country')
		}

		if (this.region === undefined) {
			throw new Error('Invalid field on _UserDelivery.save(): region')
		}

		if (this.phone_number === undefined) {
			throw new Error(
				'Invalid field on _UserDelivery.save(): phone_number',
			)
		}
